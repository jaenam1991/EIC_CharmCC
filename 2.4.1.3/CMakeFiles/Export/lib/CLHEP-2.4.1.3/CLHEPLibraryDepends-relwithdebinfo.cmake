...
set_target_properties(CLHEP::Vector PROPERTIES
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/lib/libCLHEP-Vector-2.4.1.3.dylib"
  IMPORTED_SONAME_RELWITHDEBINFO "@rpath/libCLHEP-Vector-2.4.1.3.dylib"
  )

list(APPEND _IMPORT_CHECK_TARGETS CLHEP::Vector )
list(APPEND _IMPORT_CHECK_FILES_FOR_CLHEP::Vector "${_IMPORT_PREFIX}/lib/libCLHEP-Vector-2.4.1.3.dylib" )
...
set_target_properties(CLHEP::VectorS PROPERTIES
  ...
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/lib/libCLHEP-Vector-2.4.1.3.a"
  )

list(APPEND _IMPORT_CHECK_TARGETS CLHEP::VectorS )
list(APPEND _IMPORT_CHECK_FILES_FOR_CLHEP::VectorS "${_IMPORT_PREFIX}/lib/libCLHEP-Vector-2.4.1.3.a" )
...
set_target_properties(CLHEP::Evaluator PROPERTIES
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/lib/libCLHEP-Evaluator-2.4.1.3.dylib"
  IMPORTED_SONAME_RELWITHDEBINFO "@rpath/libCLHEP-Evaluator-2.4.1.3.dylib"
  )

list(APPEND _IMPORT_CHECK_TARGETS CLHEP::Evaluator )
list(APPEND _IMPORT_CHECK_FILES_FOR_CLHEP::Evaluator "${_IMPORT_PREFIX}/lib/libCLHEP-Evaluator-2.4.1.3.dylib" )
...
set_target_properties(CLHEP::EvaluatorS PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELWITHDEBINFO "CXX"
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/lib/libCLHEP-Evaluator-2.4.1.3.a"
  )

list(APPEND _IMPORT_CHECK_TARGETS CLHEP::EvaluatorS )
list(APPEND _IMPORT_CHECK_FILES_FOR_CLHEP::EvaluatorS "${_IMPORT_PREFIX}/lib/libCLHEP-Evaluator-2.4.1.3.a" )
...
set_target_properties(CLHEP::GenericFunctions PROPERTIES
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/lib/libCLHEP-GenericFunctions-2.4.1.3.dylib"
  IMPORTED_SONAME_RELWITHDEBINFO "@rpath/libCLHEP-GenericFunctions-2.4.1.3.dylib"
  )

list(APPEND _IMPORT_CHECK_TARGETS CLHEP::GenericFunctions )
list(APPEND _IMPORT_CHECK_FILES_FOR_CLHEP::GenericFunctions "${_IMPORT_PREFIX}/lib/libCLHEP-GenericFunctions-2.4.1.3.dylib" )
...
set_target_properties(CLHEP::GenericFunctionsS PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELWITHDEBINFO "CXX"
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/lib/libCLHEP-GenericFunctions-2.4.1.3.a"
  )

list(APPEND _IMPORT_CHECK_TARGETS CLHEP::GenericFunctionsS )
list(APPEND _IMPORT_CHECK_FILES_FOR_CLHEP::GenericFunctionsS "${_IMPORT_PREFIX}/lib/libCLHEP-GenericFunctions-2.4.1.3.a" )
...
set_target_properties(CLHEP::Geometry PROPERTIES
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/lib/libCLHEP-Geometry-2.4.1.3.dylib"
  IMPORTED_SONAME_RELWITHDEBINFO "@rpath/libCLHEP-Geometry-2.4.1.3.dylib"
  )

list(APPEND _IMPORT_CHECK_TARGETS CLHEP::Geometry )
list(APPEND _IMPORT_CHECK_FILES_FOR_CLHEP::Geometry "${_IMPORT_PREFIX}/lib/libCLHEP-Geometry-2.4.1.3.dylib" )
...
set_target_properties(CLHEP::GeometryS PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELWITHDEBINFO "CXX"
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/lib/libCLHEP-Geometry-2.4.1.3.a"
  )

list(APPEND _IMPORT_CHECK_TARGETS CLHEP::GeometryS )
list(APPEND _IMPORT_CHECK_FILES_FOR_CLHEP::GeometryS "${_IMPORT_PREFIX}/lib/libCLHEP-Geometry-2.4.1.3.a" )
...
set_target_properties(CLHEP::Random PROPERTIES
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/lib/libCLHEP-Random-2.4.1.3.dylib"
  IMPORTED_SONAME_RELWITHDEBINFO "@rpath/libCLHEP-Random-2.4.1.3.dylib"
  )

list(APPEND _IMPORT_CHECK_TARGETS CLHEP::Random )
list(APPEND _IMPORT_CHECK_FILES_FOR_CLHEP::Random "${_IMPORT_PREFIX}/lib/libCLHEP-Random-2.4.1.3.dylib" )
...
set_target_properties(CLHEP::RandomS PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELWITHDEBINFO "CXX"
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/lib/libCLHEP-Random-2.4.1.3.a"
  )

list(APPEND _IMPORT_CHECK_TARGETS CLHEP::RandomS )
list(APPEND _IMPORT_CHECK_FILES_FOR_CLHEP::RandomS "${_IMPORT_PREFIX}/lib/libCLHEP-Random-2.4.1.3.a" )
...
set_target_properties(CLHEP::Matrix PROPERTIES
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/lib/libCLHEP-Matrix-2.4.1.3.dylib"
  IMPORTED_SONAME_RELWITHDEBINFO "@rpath/libCLHEP-Matrix-2.4.1.3.dylib"
  )

list(APPEND _IMPORT_CHECK_TARGETS CLHEP::Matrix )
list(APPEND _IMPORT_CHECK_FILES_FOR_CLHEP::Matrix "${_IMPORT_PREFIX}/lib/libCLHEP-Matrix-2.4.1.3.dylib" )
...
set_target_properties(CLHEP::MatrixS PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELWITHDEBINFO "CXX"
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/lib/libCLHEP-Matrix-2.4.1.3.a"
  )

list(APPEND _IMPORT_CHECK_TARGETS CLHEP::MatrixS )
list(APPEND _IMPORT_CHECK_FILES_FOR_CLHEP::MatrixS "${_IMPORT_PREFIX}/lib/libCLHEP-Matrix-2.4.1.3.a" )
...
set_target_properties(CLHEP::RandomObjects PROPERTIES
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/lib/libCLHEP-RandomObjects-2.4.1.3.dylib"
  IMPORTED_SONAME_RELWITHDEBINFO "@rpath/libCLHEP-RandomObjects-2.4.1.3.dylib"
  )

list(APPEND _IMPORT_CHECK_TARGETS CLHEP::RandomObjects )
list(APPEND _IMPORT_CHECK_FILES_FOR_CLHEP::RandomObjects "${_IMPORT_PREFIX}/lib/libCLHEP-RandomObjects-2.4.1.3.dylib" )
...
set_target_properties(CLHEP::RandomObjectsS PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELWITHDEBINFO "CXX"
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/lib/libCLHEP-RandomObjects-2.4.1.3.a"
  )

list(APPEND _IMPORT_CHECK_TARGETS CLHEP::RandomObjectsS )
list(APPEND _IMPORT_CHECK_FILES_FOR_CLHEP::RandomObjectsS "${_IMPORT_PREFIX}/lib/libCLHEP-RandomObjects-2.4.1.3.a" )
...
set_target_properties(CLHEP::Cast PROPERTIES
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/lib/libCLHEP-Cast-2.4.1.3.dylib"
  IMPORTED_SONAME_RELWITHDEBINFO "@rpath/libCLHEP-Cast-2.4.1.3.dylib"
  )

list(APPEND _IMPORT_CHECK_TARGETS CLHEP::Cast )
list(APPEND _IMPORT_CHECK_FILES_FOR_CLHEP::Cast "${_IMPORT_PREFIX}/lib/libCLHEP-Cast-2.4.1.3.dylib" )
...
set_target_properties(CLHEP::CastS PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELWITHDEBINFO "CXX"
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/lib/libCLHEP-Cast-2.4.1.3.a"
  )

list(APPEND _IMPORT_CHECK_TARGETS CLHEP::CastS )
list(APPEND _IMPORT_CHECK_FILES_FOR_CLHEP::CastS "${_IMPORT_PREFIX}/lib/libCLHEP-Cast-2.4.1.3.a" )
...
set_target_properties(CLHEP::RefCount PROPERTIES
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/lib/libCLHEP-RefCount-2.4.1.3.dylib"
  IMPORTED_SONAME_RELWITHDEBINFO "@rpath/libCLHEP-RefCount-2.4.1.3.dylib"
  )

list(APPEND _IMPORT_CHECK_TARGETS CLHEP::RefCount )
list(APPEND _IMPORT_CHECK_FILES_FOR_CLHEP::RefCount "${_IMPORT_PREFIX}/lib/libCLHEP-RefCount-2.4.1.3.dylib" )
...
set_target_properties(CLHEP::RefCountS PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELWITHDEBINFO "CXX"
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/lib/libCLHEP-RefCount-2.4.1.3.a"
  )

list(APPEND _IMPORT_CHECK_TARGETS CLHEP::RefCountS )
list(APPEND _IMPORT_CHECK_FILES_FOR_CLHEP::RefCountS "${_IMPORT_PREFIX}/lib/libCLHEP-RefCount-2.4.1.3.a" )
...
set_target_properties(CLHEP::Exceptions PROPERTIES
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/lib/libCLHEP-Exceptions-2.4.1.3.dylib"
  IMPORTED_SONAME_RELWITHDEBINFO "@rpath/libCLHEP-Exceptions-2.4.1.3.dylib"
  )

list(APPEND _IMPORT_CHECK_TARGETS CLHEP::Exceptions )
list(APPEND _IMPORT_CHECK_FILES_FOR_CLHEP::Exceptions "${_IMPORT_PREFIX}/lib/libCLHEP-Exceptions-2.4.1.3.dylib" )
...
set_target_properties(CLHEP::ExceptionsS PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELWITHDEBINFO "CXX"
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/lib/libCLHEP-Exceptions-2.4.1.3.a"
  )

list(APPEND _IMPORT_CHECK_TARGETS CLHEP::ExceptionsS )
list(APPEND _IMPORT_CHECK_FILES_FOR_CLHEP::ExceptionsS "${_IMPORT_PREFIX}/lib/libCLHEP-Exceptions-2.4.1.3.a" )
...
set_target_properties(CLHEP::CLHEP PROPERTIES
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/lib/libCLHEP-2.4.1.3.dylib"
  IMPORTED_SONAME_RELWITHDEBINFO "@rpath/libCLHEP-2.4.1.3.dylib"
  )

list(APPEND _IMPORT_CHECK_TARGETS CLHEP::CLHEP )
list(APPEND _IMPORT_CHECK_FILES_FOR_CLHEP::CLHEP "${_IMPORT_PREFIX}/lib/libCLHEP-2.4.1.3.dylib" )
...
set_target_properties(CLHEP::CLHEPS PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELWITHDEBINFO "CXX"
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/lib/libCLHEP-2.4.1.3.a"
  )

list(APPEND _IMPORT_CHECK_TARGETS CLHEP::CLHEPS )
list(APPEND _IMPORT_CHECK_FILES_FOR_CLHEP::CLHEPS "${_IMPORT_PREFIX}/lib/libCLHEP-2.4.1.3.a" )
